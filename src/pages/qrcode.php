<section class="qrcode-generator mx-auto max-w-5xl px-4 py-16 sm:py-24">
    ...
    <form id="qrcode-form" class="form mx-auto max-w-xl rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-shadow duration-300 hover:shadow-md sm:p-8 dark:border-neutral-800 dark:bg-neutral-900 dark:hover:shadow-none">
        <div class="space-y-5">
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        type="text"
                        class="text-content w-full rounded-xl border border-neutral-300 bg-white py-3 pl-11 pr-4 text-neutral-900 outline-none transition placeholder:text-neutral-400 focus:border-orange-600 focus:ring-2 focus:ring-orange-600/20 dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-100 dark:placeholder:text-neutral-500 dark:focus:border-orange-500 dark:focus:ring-orange-500/20"
                        name="text"
                        id="text"
                    >
                </div>
            ...
            <div id='preview' class="preview flex h-52 flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-neutral-300 bg-neutral-50 sm:h-64 dark:border-neutral-700 dark:bg-neutral-950">
...
<script src="/src/scripts/qcode.js"></script> <!-- Library -->
<script src="/src/scripts/qrcode.js"></script>
